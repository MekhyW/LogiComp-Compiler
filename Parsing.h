        ...
        while (current_token.type != "EOF") {
            if (current_token.type == "INT") {
                if (op == "PLUS") {
                    ...
                    throw invalid_argument("Numbers cannot be followed by another number");
                }
            } else {
                throw invalid_argument("Input must start with a number and signs cannot be followed by another sign");
            }
